...
<!-- Mirrored from adminpix.thememinister.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:43:46 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <link href="{{url('assets/plugins/emojionearea/emojionearea.min.css')}}" rel=stylesheet type="text/css"/>
        <link href="{{url('assets/plugins/monthly/monthly.min.css')}}" rel=stylesheet type="text/css"/>
        <link href="{{url('assets/plugins/amcharts/export.css')}}" rel=stylesheet type="text/css"/>
    ...
    <body class="hold-transition fixed sidebar-mini">
                                    ...
                                    <div class="message-body">
                                        <div class=message_inner2>
                                            <div class=message_widgets>
                                                ...
                                                <a href="#">
                                                    <div class=inbox-item>
                                                        <div class=inbox-item-img><img src="{{url('assets/dist/img/avatar5.png')}}" class=img-circle alt=""></div>
                        ...
                        <ul class="sidebar-menu">
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="index.html">Dashboard One</a></li>
                                    ...
                                    <ul class=chat_list>
                                        <li class=clearfix>
                                            <div class=chat-avatar>
                                                <img src="{{url('assets/dist/img/avatar4.png')}}" alt=male>
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class=chat-avatar>
                                                <img src="{{url('assets/dist/img/avatar5.png')}}" alt=Female>
                                                <i>10:01</i>
                                            </div>
                                            <div class=conversation-text>
                                                <div class=ctext-wrap>
                                        ...
                                        <li class="clearfix odd">
                                            <div class=chat-avatar>
                                                <img src="{{url('assets/dist/img/avatar5.png')}}" alt=male>
                                                <i>10:02</i>
                                            </div>
                                            <div class=conversation-text>
                                                <div class=ctext-wrap>
                                        ...
                                        <li class=clearfix>
                                            ...
                                            <div class=conversation-text>
                                                <div class=ctext-wrap>
                                                    <img src="{{url('assets/dist/img/1f600.png')}}" alt="">
                                                    <img src="{{url('assets/dist/img/1f60e.png')}}" alt="">
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
        ...
        <!-- sparkline Js -->
        <script src="{{url('assets/plugins/sparkline/sparkline.min.js')}}"></script>
        <!-- counterup Js -->
        <script src="{{url('assets/plugins/counterup/jquery.counterup.min.js')}}"></script>
        <script src="{{url('assets/plugins/counterup/waypoints.js')}}"></script>
        <!-- emojionearea Js -->
        <script src="{{url('assets/plugins/emojionearea/emojionearea.min.js')}}"></script>
        <script src="{{url('assets/plugins/monthly/monthly.min.js')}}"></script>
        <!-- amcharts Js -->
        <script src="{{url('assets/plugins/amcharts/amcharts.js')}}"></script>
        <script src="{{url('assets/plugins/amcharts/ammap.js')}}"></script>
        <script src="{{url('assets/plugins/amcharts/worldLow.js')}}"></script>
        <script src="{{url('assets/plugins/amcharts/serial.js')}}"></script>
        <script src="{{url('assets/plugins/amcharts/export.min.js')}}"></script>
        <script src="{{url('assets/plugins/amcharts/light.js')}}"></script>
        <script src="{{url('assets/plugins/amcharts/pie.js')}}"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="{{url('assets/dist/js/page/dashboard.js')}}"></script>
        <script src="{{url('assets/dist/js/theme.js')}}"></script>

    </body>

<!-- Mirrored from adminpix.thememinister.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:44:41 GMT -->
</html>